    ...
    public partial class ChartConsumoWater : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                anoBase = Convert.ToInt32(Session["yearBase"]);
                consumoApCondominioAnual(2013);
        ...
        public void consumoApCondominioAnual(int yearbase)
        {
            ...
            //----------Consumo Geral Condominio X Apartamentos -------------------///
            //--------------------------------------------------------------------////
            ...
            foreach (var item in oReciboBLL.graficoConsumoPorBloco(yearbase))
            {
